...
export const BREACHLINE_MAP: TacticalMapDefinition = {
  ...
  attackerRoutes: [
    { id: 'north', label: '북쪽 사무실 진입', points: [{ x: 120, y: 230 }, { x: 260, y: 230 }, { x: 420, y: 230 }, { x: 640, y: 230 }, { x: 790, y: 230 }] },
    { id: 'upper', label: '상부 복도 진입', points: [{ x: 120, y: 370 }, { x: 260, y: 370 }, { x: 430, y: 370 }, { x: 640, y: 370 }, { x: 790, y: 390 }] },
    { id: 'center', label: '중앙 문 진입', points: [{ x: 120, y: 510 }, { x: 260, y: 510 }, { x: 420, y: 510 }, { x: 640, y: 510 }, { x: 790, y: 520 }] },
    { id: 'lower', label: '하부 복도 진입', points: [{ x: 120, y: 650 }, { x: 260, y: 650 }, { x: 430, y: 650 }, { x: 640, y: 650 }, { x: 790, y: 650 }] },
    { id: 'south', label: '남쪽 서비스 진입', points: [{ x: 120, y: 790 }, { x: 260, y: 790 }, { x: 420, y: 790 }, { x: 640, y: 790 }, { x: 790, y: 790 }] },
  ],
  defenderSetups: [
    ...
    { id: 'site-right', label: '목표 우측', position: { x: 1190, y: 560 }, fallback: { x: 1160, y: 650 } },
