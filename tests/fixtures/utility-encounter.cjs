...
exports.utilityEncounter=(seed=1)=>{
  ...
  return new Arena().run({attackers:[make('해동','공격',0),make('MAGPIE','공격',1)],defenders:[make('REUSS','수비',2),make('REUSS','수비',3)],map:{...BREACHLINE_MAP,walls:[{id:'fixture-partition',kind:'interior',from:{x:800,y:1200},to:{x:800,y:2300}}],covers:[],portals:[]},maxSeconds:15,seed});
};
